...
kidney_phrases = {
    ...
    "capsule": [
        ...
        "delineate renal capsule",
        "outline kidney capsule boundary",
        "capsular layer of the kidney",
        "identify renal encapsulation"
    ],
    "medulla": [
        "segment kidney medulla",
        "delineate renal medullary region",
        "outline medulla of the kidney",
        "medullary area of kidney",
        "identify renal medulla"
    ],
    "central echo complex": [
        "segment central echo complex of kidney",
        "delineate kidney central echo complex",
        "renal central echo complex",
        "outline central echoes of kidney",
        "delineate renal central echo complex"
    ]
}
