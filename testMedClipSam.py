...
datasets = ["stu","s1","tn3k","tg3k","105us",
            "aul","muregpro","regpro","kidnyus"]
for selectedDataset in datasets:
    ...
    for image_index,image_name in enumerate(textCSV):
        ...
        # mded_clip_sam_path = f'/home/hamze/Documents/Grounding-Sam-Ultrasound/visualizations/GroundedSAM-US_unseen/MedCLIP-SAM/{selectedDataset}_unseen/{image_name}'.replace('png','npz').replace('jpg','npz').replace('.bmp','.npz').replace('.tif','.npz')
